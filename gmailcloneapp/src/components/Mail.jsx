...
import { MdDeleteOutline, MdKeyboardArrowLeft, MdKeyboardArrowRight, MdOutlineAddTask, MdOutlineDriveFileMove, MdOutlineMarkEmailUnread, MdOutlineReport, MdOutlineTask, MdOutlineWatchLater } from 'react-icons/md'
...
function Mail() {
  ...
  return (
    <div className=' flex-1 bg-white rounded-xl mx-5'>
      ...
      <div className="h-[90-vh] overflow-y-auto p-4">
